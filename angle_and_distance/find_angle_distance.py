...
class Find_angle_distance:
	...
	def __init__(self, eye_center, re_screen = 0):
	...
	def change_point_start_vertical(self):
		...
		if self.point_y < self.set_camera()[0] :
			self.status_gaze_vt = "UP"
		else:
			self.status_gaze_vt = "DOWN"
	...
	def estimate_distance(self, eye_right, est=2.6):
		# Equation Angle Tan
		# Compute Angle B
		# Compute Line AD to Cm
		# Compute Distance
		tan_round = lambda a : math.tan(math.radians(a)) 
		angle_B = math.atan2(abs(self.point_x - eye_right[0]),
